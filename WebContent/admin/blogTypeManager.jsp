...
<script type="text/javascript">
	...
	function openBlogTypeAddDialog() {
		...
		url = "${pageContext.request.contextPath}/admin/blogType/addType";
	}
	...
	function openBlogTypeModifyDialog() {
		...
		url = "${pageContext.request.contextPath}/admin/blogType/addType?typeId="+ row.typeId ;
	}
	...
	function deleteBlogType() {
		...
		for(var i = 0; i < selectedRows.length; i++) {
			idsStr.push(selectedRows[i].typeId);
		}
		var ids = idsStr.join(","); //1,2,3,4
		$.messager.confirm("系统提示", "<font color=red>您确定要删除选中的"+selectedRows.length+"条数据么？</font>", function(r) {
			if(r) {
				$.post("${pageContext.request.contextPath}/admin/blogType/delType",
...
<body>
	<table id="dg" title="博客类别管理" fit="true" class="easyui-datagrid"
		fitColumns="true" pagination="true"
		url="${pageContext.request.contextPath}/admin/blogType/listType"
		toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="typeOrderNum" width="100" align="center">类别排序</th>
			</tr>
		</thead>
	</table>
	<div id="tb">
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" enctype="multipart/form-data">
			<table cellspacing="8px">
				<tr>
					<td>类别封面</td>
					<td><input type="file" id="file" name="file" class="easyui-filebox" required="true"></td>
				</tr>
				<tr>
					<td>博客类别名称</td>
				...
				<tr>
					<td>博客类别排序</td>
					<td><input type="text" id="typeOrderNum" name="typeOrderNum"
