...
<table id="dg" title="评论管理" class="easyui-datagrid" fitColumns="true" pagination="true"
	url="${blog}/comment/listComment?type=1" toolbar="#tb" fit="true">
	<thead>
		<tr>
			...
			<th field="commenterName" width="50" align="center">用户的昵称</th> 
			<th field="commentContent" width="200" align="center">评论内容</th> 
			<th field="commentDate" width="50" align="center">评论日期</th> 
			<th field="commentState" width="50" align="center" formatter="formatState">评论状态</th> 
		</tr>
	</thead>
</table>
<div id="tb"> 
