...
<body>
		...
		<DIV
			...
			<P style="padding: 30px 0px 10px; position: relative;">
				...
				<INPUT id="username" name="userName" class="ipt" type="text" 
					placeholder="请输入用户名" value="${errorBlogger.userName }">
			</P>
			<P style="position: relative;">
				<SPAN class="p_logo"></SPAN> 
				<INPUT id="password" name="userPassword" class="ipt" type="password" 
					placeholder="请输入密码" >
			</P>
			<DIV
				style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
				<P style="margin: 0px 35px 20px 45px;">
					<SPAN style="float: left;">Sean Way博客系统</SPAN> 
	...
	<div style="text-align:center;padding-top: 30px">Copyright &copy; 2018.Sean Young All rights reserved.</div>
</body>
</html>